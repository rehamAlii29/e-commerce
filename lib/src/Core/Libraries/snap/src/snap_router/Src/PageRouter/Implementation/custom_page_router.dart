...
class CustomPageRouterCreator implements PageRouterCreator {
  ...
  Route<T> create<T>(
    ...
    final options = animationOptions ?? (transitionType == parentTransition ? parentOptions : null);
    ...
    return PageRouteBuilder(
      ...
      settings: settings,
      maintainState: true,
      transitionDuration: options?.duration ?? RouterConstants.transitionDuration,
      reverseTransitionDuration: options?.reverseDuration ?? RouterConstants.reverseTransitionDuration,
